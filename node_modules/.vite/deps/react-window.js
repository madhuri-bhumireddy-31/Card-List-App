...
function memoizeOne(resultFn, isEqual$1) {
	...
	function memoized() {
		...
		if (calledOnce && lastThis === this && isEqual$1(newArgs, lastArgs)) return lastResult;
...
var defaultItemKey = function defaultItemKey$2(_ref) {
...
function createGridComponent(_ref2) {
	...
	return _class = /* @__PURE__ */ function(_PureComponent) {
		...
		_proto.scrollToItem = function scrollToItem(_ref4) {
			...
			var estimatedTotalHeight = getEstimatedTotalHeight$1(this.props, this._instanceProps);
			var horizontalScrollbarSize = getEstimatedTotalWidth$1(this.props, this._instanceProps) > width ? scrollbarSize : 0;
		...
		_proto.render = function render() {
			...
			var estimatedTotalHeight = getEstimatedTotalHeight$1(this.props, this._instanceProps);
			var estimatedTotalWidth = getEstimatedTotalWidth$1(this.props, this._instanceProps);
...
var validateSharedProps = function validateSharedProps$2(_ref5, _ref6) {
...
var getEstimatedTotalHeight = function getEstimatedTotalHeight$1(_ref, _ref2) {
...
var getEstimatedTotalWidth = function getEstimatedTotalWidth$1(_ref3, _ref4) {
...
var getItemMetadata = function getItemMetadata$2(itemType, props, index, instanceProps) {
...
var findNearestItem = function findNearestItem$2(itemType, props, instanceProps, offset) {
...
var findNearestItemBinarySearch = function findNearestItemBinarySearch$2(itemType, props, instanceProps, high, low, offset) {
	while (low <= high) {
...
var findNearestItemExponentialSearch = function findNearestItemExponentialSearch$2(itemType, props, instanceProps, index, offset) {
...
var getOffsetForIndexAndAlignment = function getOffsetForIndexAndAlignment$1(itemType, props, index, align, scrollOffset, instanceProps, scrollbarSize) {
	var size$1 = itemType === "column" ? props.width : props.height;
	var itemMetadata = getItemMetadata(itemType, props, index, instanceProps);
	var estimatedTotalSize = itemType === "column" ? getEstimatedTotalWidth(props, instanceProps) : getEstimatedTotalHeight(props, instanceProps);
	var maxOffset = Math.max(0, Math.min(estimatedTotalSize - size$1, itemMetadata.offset));
	var minOffset = Math.max(0, itemMetadata.offset - size$1 + scrollbarSize + itemMetadata.size);
	if (align === "smart") if (scrollOffset >= minOffset - size$1 && scrollOffset <= maxOffset + size$1) align = "auto";
	else align = "center";
	switch (align) {
...
var defaultItemKey$1 = function defaultItemKey$2(index, data) {
	return index;
};
...
function createListComponent(_ref) {
	var _class;
	var getItemOffset = _ref.getItemOffset, getEstimatedTotalSize$1 = _ref.getEstimatedTotalSize, getItemSize = _ref.getItemSize, getOffsetForIndexAndAlignment$1 = _ref.getOffsetForIndexAndAlignment, getStartIndexForOffset = _ref.getStartIndexForOffset, getStopIndexForStartIndex = _ref.getStopIndexForStartIndex, initInstanceProps = _ref.initInstanceProps, shouldResetStyleCacheOnItemSizeChange = _ref.shouldResetStyleCacheOnItemSizeChange, validateProps = _ref.validateProps;
	return _class = /* @__PURE__ */ function(_PureComponent) {
		...
		function List(props) {
			...
			_this._getItemStyle = function(index) {
				...
				if (itemStyleCache.hasOwnProperty(index)) style = itemStyleCache[index];
					...
					var size$1 = getItemSize(_this.props, index, _this._instanceProps);
					...
					itemStyleCache[index] = style = {
						...
						height: !isHorizontal ? size$1 : "100%",
						width: isHorizontal ? size$1 : "100%"
					};
				}
				return style;
			};
		...
		_proto.scrollToItem = function scrollToItem(index, align) {
			...
			this.scrollTo(getOffsetForIndexAndAlignment$1(this.props, index, align, scrollOffset, this._instanceProps, scrollbarSize));
		};
		_proto.componentDidMount = function componentDidMount() {
		...
		_proto.render = function render() {
			...
			var estimatedTotalSize = getEstimatedTotalSize$1(this.props, this._instanceProps);
			return (0, import_react.createElement)(outerElementType || outerTagName || "div", {
				className,
				onScroll,
				ref: this._outerRefSetter,
...
var validateSharedProps$1 = function validateSharedProps$2(_ref2, _ref3) {
...
var getItemMetadata$1 = function getItemMetadata$2(props, index, instanceProps) {
...
var findNearestItem$1 = function findNearestItem$2(props, instanceProps, offset) {
	var itemMetadataMap = instanceProps.itemMetadataMap, lastMeasuredIndex = instanceProps.lastMeasuredIndex;
...
var findNearestItemBinarySearch$1 = function findNearestItemBinarySearch$2(props, instanceProps, high, low, offset) {
	while (low <= high) {
		var middle = low + Math.floor((high - low) / 2);
...
var findNearestItemExponentialSearch$1 = function findNearestItemExponentialSearch$2(props, instanceProps, index, offset) {
...
var getEstimatedTotalSize = function getEstimatedTotalSize$1(_ref2, _ref3) {
...
var VariableSizeList = /* @__PURE__ */ createListComponent({
	...
	getOffsetForIndexAndAlignment: function getOffsetForIndexAndAlignment$1(props, index, align, scrollOffset, instanceProps, scrollbarSize) {
		var direction = props.direction, height = props.height, layout = props.layout, width = props.width;
		var size$1 = direction === "horizontal" || layout === "horizontal" ? width : height;
		var itemMetadata = getItemMetadata$1(props, index, instanceProps);
		var estimatedTotalSize = getEstimatedTotalSize(props, instanceProps);
		var maxOffset = Math.max(0, Math.min(estimatedTotalSize - size$1, itemMetadata.offset));
		var minOffset = Math.max(0, itemMetadata.offset - size$1 + itemMetadata.size + scrollbarSize);
		if (align === "smart") if (scrollOffset >= minOffset - size$1 && scrollOffset <= maxOffset + size$1) align = "auto";
		else align = "center";
		switch (align) {
			case "start": return maxOffset;
	...
	getStopIndexForStartIndex: function getStopIndexForStartIndex(props, startIndex, scrollOffset, instanceProps) {
		...
		var maxOffset = scrollOffset + size$1;
		var offset = itemMetadata.offset + itemMetadata.size;
		var stopIndex = startIndex;
...
var FixedSizeGrid = /* @__PURE__ */ createGridComponent({
	...
	getEstimatedTotalHeight: function getEstimatedTotalHeight$1(_ref5) {
		var rowCount = _ref5.rowCount;
		return _ref5.rowHeight * rowCount;
	},
	getEstimatedTotalWidth: function getEstimatedTotalWidth$1(_ref6) {
...
var FixedSizeList = /* @__PURE__ */ createListComponent({
	...
	getEstimatedTotalSize: function getEstimatedTotalSize$1(_ref3) {
		var itemCount = _ref3.itemCount;
		return _ref3.itemSize * itemCount;
	},
	getOffsetForIndexAndAlignment: function getOffsetForIndexAndAlignment$1(_ref4, index, align, scrollOffset, instanceProps, scrollbarSize) {
		...
		var size$1 = direction === "horizontal" || layout === "horizontal" ? width : height;
		var lastItemOffset = Math.max(0, itemCount * itemSize - size$1);
		var maxOffset = Math.min(lastItemOffset, index * itemSize);
		var minOffset = Math.max(0, index * itemSize - size$1 + itemSize + scrollbarSize);
		if (align === "smart") if (scrollOffset >= minOffset - size$1 && scrollOffset <= maxOffset + size$1) align = "auto";
		else align = "center";
		switch (align) {
			case "start": return maxOffset;
			...
			case "center":
				var middleOffset = Math.round(minOffset + (maxOffset - minOffset) / 2);
				if (middleOffset < Math.ceil(size$1 / 2)) return 0;
				else if (middleOffset > lastItemOffset + Math.floor(size$1 / 2)) return lastItemOffset;
				else return middleOffset;
			case "auto":
			default: if (scrollOffset >= minOffset && scrollOffset <= maxOffset) return scrollOffset;
			else if (scrollOffset < minOffset) return minOffset;
	...
	getStopIndexForStartIndex: function getStopIndexForStartIndex(_ref6, startIndex, scrollOffset) {
		...
		var size$1 = isHorizontal ? width : height;
		var numVisibleItems = Math.ceil((size$1 + scrollOffset - offset) / itemSize);
