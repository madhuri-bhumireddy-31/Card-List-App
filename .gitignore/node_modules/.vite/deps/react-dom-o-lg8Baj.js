...
import { require_react } from "./react-WszNPbCI.js";
...
var require_react_dom_development = /* @__PURE__ */ __commonJS({ "node_modules/react-dom/cjs/react-dom.development.js": ((exports) => {
	(function() {
		...
		*/
		...
		var VALID_ATTRIBUTE_NAME_REGEX = /* @__PURE__ */ new RegExp("^[" + ATTRIBUTE_NAME_START_CHAR + "][" + ATTRIBUTE_NAME_CHAR + "]*$");
			...
			switch (typeof value) {
				...
				case "boolean":
					...
					if (propertyInfo !== null) return !propertyInfo.acceptsBooleans;
						...
						return prefix$1 !== "data-" && prefix$1 !== "aria-";
					}
		...
		*/
		function prefixKey(prefix$1, key) {
			return prefix$1 + key.charAt(0).toUpperCase() + key.substring(1);
		}
		/**
		...
		*/
		...
		Object.keys(isUnitlessNumber).forEach(function(prop) {
			prefixes.forEach(function(prefix$1) {
				isUnitlessNumber[prefixKey(prefix$1, prop)] = isUnitlessNumber[prop];
			});
		});
		/**
		...
		*/
		...
		var rARIA = /* @__PURE__ */ new RegExp("^(aria)-[" + ATTRIBUTE_NAME_CHAR + "]*$");
		var rARIACamel = /* @__PURE__ */ new RegExp("^(aria)[A-Z][" + ATTRIBUTE_NAME_CHAR + "]*$");
		...
		var rARIA$1 = /* @__PURE__ */ new RegExp("^(aria)-[" + ATTRIBUTE_NAME_CHAR + "]*$");
		var rARIACamel$1 = /* @__PURE__ */ new RegExp("^(aria)[A-Z][" + ATTRIBUTE_NAME_CHAR + "]*$");
		...
		*/
		...
		if (typeof window !== "undefined" && typeof window.dispatchEvent === "function" && typeof document !== "undefined" && typeof document.createEvent === "function") {
			...
			invokeGuardedCallbackImpl = function invokeGuardedCallbackDev(name, func, context, a, b, c, d, e, f) {
				...
				if (didCall && didError) {
					if (!didSetError) error$1 = /* @__PURE__ */ new Error("An error was thrown inside one of your components, but React doesn't know what it was. This is likely due to browser flakiness. React does its best to preserve the \"Pause on exceptions\" behavior of the DevTools, which requires some DEV-mode only tricks. It's possible that these don't work in your browser. Try triggering the error in production mode, or switching to a modern browser. If you suspect that this is actually an issue with React, please file an issue.");
					else if (isCrossOriginError) error$1 = /* @__PURE__ */ new Error("A cross-origin error was thrown. React doesn't have access to the actual error object in development. See https://reactjs.org/link/crossorigin-error for more information.");
					this.onError(error$1);
				}
		...
		*/
		...
		function onCommitRoot(root$1, eventPriority) {
			if (injectedHook && typeof injectedHook.onCommitFiberRoot === "function") try {
				...
				} else injectedHook.onCommitFiberRoot(rendererID, root$1, void 0, didError);
			} catch (err) {
				if (!hasLoggedError) {
					hasLoggedError = true;
					error("React instrumentation encountered an error: %s", err);
		...
		function addFiberToLanesMap(root$1, fiber, lanes) {
			...
			while (lanes > 0) {
				...
				var lane = 1 << index$1;
				pendingUpdatersLaneMap[index$1].add(fiber);
				lanes &= ~lane;
			}
		}
		...
		function isRootDehydrated(root$1) {
			return root$1.current.memoizedState.isDehydrated;
		}
		...
		*/
		...
		function getMaskedContext(workInProgress$1, unmaskedContext) {
			var contextTypes = workInProgress$1.type.contextTypes;
		...
		function pushMaterializedTreeId(workInProgress$1) {
			warnIfNotHydrating();
			if (workInProgress$1.return !== null) {
				var numberOfForks = 1;
				var slotIndex = 0;
		...
		*/
		...
		function cloneUpdateQueue(current$1, workInProgress$1) {
			...
			if (queue === currentQueue) workInProgress$1.updateQueue = {
			...
			if (firstBaseUpdate !== null) {
				...
				do {
					...
					if (!isSubsetOfLanes(renderLanes$1, updateLane)) {
						...
						if (newLastBaseUpdate !== null) newLastBaseUpdate = newLastBaseUpdate.next = {
							eventTime: updateEventTime,
							lane: NoLane,
							tag: update.tag,
							payload: update.payload,
		...
		function shouldCaptureSuspense(workInProgress$1, hasInvisibleParent) {
			...
			workInProgress$1.memoizedProps;
			return true;
		}
			...
			if (baseQueue !== null) {
				...
				do {
					...
					if (!isSubsetOfLanes(renderLanes, updateLane)) {
						...
						if (newBaseQueueLast !== null) newBaseQueueLast = newBaseQueueLast.next = {
							lane: NoLane,
							action: update.action,
							hasEagerState: update.hasEagerState,
							eagerState: update.eagerState,
		...
		*/
		...
		function constructClassInstance(workInProgress$1, ctor, props) {
			...
			var state = workInProgress$1.memoizedState = instance.state !== null && instance.state !== void 0 ? instance.state : null;
		...
		function updateClassComponent(current$1, workInProgress$1, Component, nextProps, renderLanes$1) {
			switch (shouldError(workInProgress$1)) {
				case false:
					...
					var ctor = workInProgress$1.type;
					var state = new ctor(workInProgress$1.memoizedProps, _instance.context).state;
		...
		function updateHostRoot(current$1, workInProgress$1, renderLanes$1) {
			...
			if (prevState.isDehydrated) {
				...
				if (workInProgress$1.flags & ForceClientRender) {
					var recoverableError = createCapturedValueAtFiber(/* @__PURE__ */ new Error("There was an error while hydrating. Because the error happened outside of a Suspense boundary, the entire root will switch to client rendering."), workInProgress$1);
					return mountHostRootWithoutHydrating(current$1, workInProgress$1, nextChildren, renderLanes$1, recoverableError);
				} else if (nextChildren !== prevChildren) {
					var _recoverableError = createCapturedValueAtFiber(/* @__PURE__ */ new Error("This root received an early update, before anything was able hydrate. Switched the entire root to client rendering."), workInProgress$1);
		...
		function mountIndeterminateComponent(_current, workInProgress$1, Component, renderLanes$1) {
			...
			if (typeof value === "object" && value !== null && typeof value.render === "function" && value.$$typeof === void 0) {
				...
				workInProgress$1.memoizedState = value.state !== null && value.state !== void 0 ? value.state : null;
				initializeUpdateQueue(workInProgress$1);
		...
		function shouldRemainOnFallback(suspenseContext, current$1, workInProgress$1, renderLanes$1) {
			if (current$1 !== null) {
				if (current$1.memoizedState === null) return false;
			}
		...
		function updateSuspenseFallbackChildren(current$1, workInProgress$1, primaryChildren, fallbackChildren, renderLanes$1) {
			...
			if ((mode & ConcurrentMode) === NoMode && workInProgress$1.child !== currentPrimaryChildFragment) {
				primaryChildFragment = workInProgress$1.child;
				primaryChildFragment.childLanes = NoLanes;
				primaryChildFragment.pendingProps = primaryChildProps;
				if (workInProgress$1.mode & ProfileMode) {
					primaryChildFragment.actualDuration = 0;
		...
		function retrySuspenseComponentWithoutHydrating(current$1, workInProgress$1, renderLanes$1, recoverableError) {
			...
			var primaryChildren = workInProgress$1.pendingProps.children;
		...
		function updateDehydratedSuspenseComponent(current$1, workInProgress$1, didSuspend, nextProps, suspenseInstance, suspenseState, renderLanes$1) {
			if (!didSuspend) {
				warnIfHydrating();
				if ((workInProgress$1.mode & ConcurrentMode) === NoMode) return retrySuspenseComponentWithoutHydrating(current$1, workInProgress$1, renderLanes$1, null);
				if (isSuspenseInstanceFallback(suspenseInstance)) {
					...
					else error$1 = /* @__PURE__ */ new Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering.");
				...
				if (didReceiveUpdate || hasContextChanged$1) {
					...
					renderDidSuspendDelayIfPossible();
					var _capturedValue = createCapturedValue(/* @__PURE__ */ new Error("This Suspense boundary received an update before it finished hydrating. This caused the boundary to switch to client rendering. The usual way to fix this is to wrap the original update in startTransition."));
				...
				workInProgress$1.flags &= ~ForceClientRender;
				var _capturedValue2 = createCapturedValue(/* @__PURE__ */ new Error("There was an error while hydrating this Suspense boundary. Switched to client rendering."));
		...
		function propagateSuspenseContextChange(workInProgress$1, firstChild, renderLanes$1) {
			...
			while (node !== null) {
				if (node.tag === SuspenseComponent) {
					if (node.memoizedState !== null) scheduleSuspenseWorkOnFiber(node, renderLanes$1, workInProgress$1);
		...
		function updateSuspenseListComponent(current$1, workInProgress$1, renderLanes$1) {
			...
			if (hasSuspenseContext(suspenseContext, ForceSuspenseFallback)) {
				...
				if (current$1 !== null && (current$1.flags & DidCapture) !== NoFlags) propagateSuspenseContextChange(workInProgress$1, workInProgress$1.child, renderLanes$1);
				suspenseContext = setDefaultShallowSuspenseContext(suspenseContext);
			}
			pushSuspenseContext(workInProgress$1, suspenseContext);
			if ((workInProgress$1.mode & ConcurrentMode) === NoMode) workInProgress$1.memoizedState = null;
				...
				case "backwards":
					...
					break;
				case "together":
					initSuspenseListRenderState(workInProgress$1, false, null, null, void 0);
					break;
		...
		function updateContextConsumer(current$1, workInProgress$1, renderLanes$1) {
			...
			var render$1 = workInProgress$1.pendingProps.children;
		...
		function attemptEarlyBailoutIfNoScheduledUpdate(current$1, workInProgress$1, renderLanes$1) {
			switch (workInProgress$1.tag) {
				...
				case ContextProvider:
					...
					break;
				case Profiler:
					if (includesSomeLane(renderLanes$1, workInProgress$1.childLanes)) workInProgress$1.flags |= Update;
					var stateNode = workInProgress$1.stateNode;
					stateNode.effectDuration = 0;
					stateNode.passiveEffectDuration = 0;
					break;
				case SuspenseComponent:
					...
					if (state !== null) {
						...
						var primaryChildLanes = workInProgress$1.child.childLanes;
		...
		function beginWork(current$1, workInProgress$1, renderLanes$1) {
			...
			if (current$1 !== null) {
				...
				if (oldProps !== newProps || hasContextChanged() || workInProgress$1.type !== current$1.type) didReceiveUpdate = true;
					...
					if (!checkScheduledUpdateOrContext(current$1, renderLanes$1) && (workInProgress$1.flags & DidCapture) === NoFlags) {
						didReceiveUpdate = false;
			...
			switch (workInProgress$1.tag) {
				...
				case Fragment: return updateFragment(current$1, workInProgress$1, renderLanes$1);
			...
			switch (workInProgress$1.tag) {
				...
				case HostRoot:
					...
					if (current$1 === null || current$1.child === null) {
						if (popHydrationState(workInProgress$1)) markUpdate(workInProgress$1);
						else if (current$1 !== null) {
							if (!current$1.memoizedState.isDehydrated || (workInProgress$1.flags & ForceClientRender) !== NoFlags) {
				...
				case SuspenseComponent:
					...
					if (current$1 === null || current$1.memoizedState !== null && current$1.memoizedState.dehydrated !== null) {
						if (!completeDehydratedSuspenseBoundary(current$1, workInProgress$1, nextState)) if (workInProgress$1.flags & ShouldCapture) return workInProgress$1;
						else return null;
					}
					...
					if (nextDidTimeout !== prevDidTimeout) {
						if (nextDidTimeout) {
							...
							if ((workInProgress$1.mode & ConcurrentMode) !== NoMode) if (current$1 === null && (workInProgress$1.memoizedProps.unstable_avoidThisFallback !== true || !enableSuspenseAvoidThisFallback) || hasSuspenseContext(suspenseStackCursor.current, InvisibleParentSuspenseContext)) renderDidSuspend();
							else renderDidSuspendDelayIfPossible();
						}
					}
					if (workInProgress$1.updateQueue !== null) workInProgress$1.flags |= Update;
					bubbleProperties(workInProgress$1);
					if ((workInProgress$1.mode & ProfileMode) !== NoMode) {
						if (nextDidTimeout) {
							var primaryChildFragment = workInProgress$1.child;
				...
				case SuspenseListComponent:
					...
					if (renderedTail === null) if (!didSuspendAlready) {
						if (!(renderHasNotSuspendedYet() && (current$1 === null || (current$1.flags & DidCapture) === NoFlags))) {
							var row = workInProgress$1.child;
							while (row !== null) {
				...
				case LegacyHiddenComponent:
					...
					var nextIsHidden = workInProgress$1.memoizedState !== null;
					if (current$1 !== null) {
						if (current$1.memoizedState !== null !== nextIsHidden && !enableLegacyHidden) workInProgress$1.flags |= Visibility;
					}
		...
		function commitBeforeMutationEffects(root$1, firstChild) {
			prepareForCommit(root$1.containerInfo);
		...
		function commitMutationEffectsOnFiber(finishedWork, root$1, lanes) {
			...
			switch (finishedWork.tag) {
				...
				case HostRoot:
					...
					if (flags & Update) {
						if (current$1 !== null) {
							if (current$1.memoizedState.isDehydrated) try {
			...
			while (nextEffect !== null) {
				...
				if (fiber.tag === OffscreenComponent && isModernRoot) {
					...
					if (newOffscreenSubtreeIsHidden) {
						...
						var current$1 = fiber.alternate;
						var newOffscreenSubtreeWasHidden = current$1 !== null && current$1.memoizedState !== null || offscreenSubtreeWasHidden;
		...
		function performConcurrentWorkOnRoot(root$1, didTimeout) {
			...
			var exitStatus = !includesBlockingLane(root$1, lanes) && !includesExpiredLane(root$1, lanes) && !didTimeout ? renderRootConcurrent(root$1, lanes) : renderRootSync(root$1, lanes);
			...
			switch (exitStatus) {
				...
				case RootSuspended:
					...
					if (includesOnlyRetries(lanes) && !shouldForceFlushFallbacksInDEV()) {
						...
						if (msUntilTimeout > 10) {
							if (getNextLanes(root$1, NoLanes) !== NoLanes) break;
							var suspendedLanes = root$1.suspendedLanes;
				...
				case RootSuspendedWithDelay:
					...
					if (!shouldForceFlushFallbacksInDEV()) {
						var eventTimeMs = getMostRecentEventTime(root$1, lanes);
		...
		function performSyncWorkOnRoot(root$1) {
			...
			root$1.finishedWork = root$1.current.alternate;
			root$1.finishedLanes = lanes;
			commitRoot(root$1, workInProgressRootRecoverableErrors, workInProgressTransitions);
			ensureRootIsScheduled(root$1, now());
			return null;
		...
		function commitRootImpl(root$1, recoverableErrors, transitions, renderPriorityLevel) {
			...
			if (subtreeHasEffects || rootHasEffect) {
				...
				ReactCurrentOwner$2.current = null;
				commitBeforeMutationEffects(root$1, finishedWork);
				recordCommitTime();
		...
		function restorePendingUpdaters(root$1, lanes) {
			if (isDevToolsPresent) root$1.memoizedUpdaters.forEach(function(schedulingFiber) {
		...
		function createHydrationContainer(initialChildren, callback, containerInfo, tag, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError, transitionCallbacks) {
			var root$1 = createFiberRoot(containerInfo, tag, true, initialChildren, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError);
		...
		var copyWithRenameImpl = function(obj, oldPath, newPath, index$1) {
			...
			} else updated[oldKey] = copyWithRenameImpl(obj[oldKey], oldPath, newPath, index$1 + 1);
			return updated;
		};
		...
		function createRoot(container, options$1) {
			...
			if (options$1 !== null && options$1 !== void 0) {
				...
				if (options$1.identifierPrefix !== void 0) identifierPrefix = options$1.identifierPrefix;
				if (options$1.onRecoverableError !== void 0) onRecoverableError = options$1.onRecoverableError;
				if (options$1.transitionCallbacks !== void 0) options$1.transitionCallbacks;
			}
...
//# sourceMappingURL=react-dom-o-lg8Baj.js.map